    ...
    var goatImageElement = document.querySelector(".goat-image");
    ...
    var zombieImageElement = document.querySelectorAll(".goat-image")[1];
    ...
    var goatAttacks = [
      ...
      { name: "Horn Blade", power: 9, accuracy: 0.4, description: "Slashes with sharp and pointy horns." },
    ...
    var zombieAttacks = [
      ...
      { name: "Zombie Puke", power: 9, accuracy: 0.4, description: "Spits poisonous vomit on opponent." },
    ...
    goatAttackButton.addEventListener("click", function() {
      var selectAttack = document.getElementById("goat-attack-select");
